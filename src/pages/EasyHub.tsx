...
function MarketplaceTileCard({ tile, onClick }: { tile: MarketplaceTile; onClick: () => void }) {
  ...
  return (
    <div
      className={cn(
        "group cursor-pointer transition-all duration-300 rounded-2xl overflow-hidden shadow-md hover:shadow-2xl hover:-translate-y-1 relative bg-white border border-border/40 flex flex-col",
    ...
    >
      ...
      <div className="relative aspect-[2/1] overflow-hidden">
        ...
        {/* Hover arrow */}
        <div className="absolute top-3 right-3 h-9 w-9 rounded-full bg-white/95 backdrop-blur flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity shadow-md">
      ...
      {/* White caption below */}
      <div className="px-4 py-4 md:px-5 md:py-4 bg-white flex-1 flex flex-col justify-center">
        <h3 className="font-extrabold text-lg md:text-xl leading-tight text-slate-900">
          {tile.title}
        </h3>
        <p className="text-sm md:text-base mt-1.5 text-slate-700 font-semibold leading-snug line-clamp-2">
          {tile.description}
        </p>
      </div>
    </div>
