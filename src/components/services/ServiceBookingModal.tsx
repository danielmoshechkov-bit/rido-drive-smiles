            ...
            <div className="space-y-3">
              ...
              <Card className="bg-muted/50">
                <CardContent className="p-3 text-sm space-y-1">
                  ...
                  <div className="flex justify-between"><span className="text-muted-foreground">Cena orientacyjna:</span><span className="font-bold text-primary">{service.price} zł</span></div>
                </CardContent>
              </Card>
