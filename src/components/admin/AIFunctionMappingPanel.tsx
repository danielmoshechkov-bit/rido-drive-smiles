...
const FUNCTION_MODULES: Record<string, string> = {
  ...
  ocr_invoice: "faktury",
  ocr_documents: "faktury",
  invoice_recognition: "faktury",
  invoice_booking: "faktury",
  supplier_mapping: "faktury",
  ksef_integration: "faktury",
...
const MODULE_CONFIG = [
  ...
  { value: "faktury", label: "Faktury & Księgowość" },
