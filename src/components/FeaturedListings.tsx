  ...
  const fetchListings = async () => {
    ...
    try {
      ...
      const { data: services } = await (supabase as any)
        ...
        .select('id, company_name, logo_url, cover_image_url, gallery_photos, company_city, category_id, status, rating_avg, rating_count, description, category:service_categories(id, name, slug), services(id, name, price, is_featured), provider_services(id, name, price_from, price_to, is_active)')
        .eq('status', 'active')
