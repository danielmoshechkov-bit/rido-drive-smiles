-- ================================================================
-- RIDO FLEET + DRIVER PORTAL - Database Migration (Fixed)
-- ================================================================
...
-- Użytkownicy aplikacji kierowcy
...
-- RLS policies (poprawiona składnia)
ALTER TABLE fleets ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "Admins can manage fleets" ON fleets;
CREATE POLICY "Admins can manage fleets" ON fleets FOR ALL USING (true);

ALTER TABLE driver_app_users ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "Admins can manage driver app users" ON driver_app_users;
CREATE POLICY "Admins can manage driver app users" ON driver_app_users FOR ALL USING (true);

ALTER TABLE fuel_logs ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "Admins can manage fuel logs" ON fuel_logs;
CREATE POLICY "Admins can manage fuel logs" ON fuel_logs FOR ALL USING (true);
...
-- Storage bucket dla dokumentów kierowcy
