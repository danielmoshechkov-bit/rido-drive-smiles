  ...
  try {
    ...
    if (snapshotRaw) {
      snapshotBlok = `\n\n=== CO WIESZ O DZIŚ (dane pobrane przy odebraniu połączenia) ===\n${snapshotRaw}\n`
        ...
        + `- DWIE GODZINY NA RAZ, NIGDY TRZY. Pole "wolne_do_wypowiedzenia" jest ZAPASEM do wyboru, nie listą do odczytania. Wybierasz z niego DWIE i tylko te wypowiadasz. PRAWDZIWA ROZMOWA 15.08: agent przeczytał wszystkie trzy — "w dziewięć, w dwanaście trzydzieści albo w cztery po południu" — klient milczał dziewięć sekund i odpowiedział czymś, czego transkrypcja nie rozpoznała. Trzy opcje w słuchawce to o jedną za dużo, żeby je zapamiętać.\n`
