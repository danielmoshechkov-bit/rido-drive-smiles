...
Deno.serve((req) => {
  ...
  return jsonResponse(req, 503, {
    error: "trusted_registration_delivery_required",
    message: "Wysyłka wiadomości rejestracyjnych wymaga zaufanej kolejki i odbiorcy wyznaczonego po stronie serwera",
  });
});
