...
Deno.serve(async (req) => {
  ...
  try {
     ...
     * `INSERT` (`PGRST204`, „column not found") — czyli każdy klient
     * zobaczyłby „Nie udało się rozpocząć płatności", a przyczyną byłoby
     * pole analityczne.
     *
     * Dlatego przy TEJ jednej klasie błędu zakładamy zamówienie jeszcze raz,
     * bez pól analitycznych. Pierwsza próba nie zostawiła wiersza, więc nie
     * ma mowy o podwójnym zamówieniu. Tracimy dopasowanie konwersji do czasu
