// KOPIA src/lib/smsModeration.ts dla funkcji brzegowych (Deno nie sięga do src/).
//
// Blokada MUSI stać po stronie serwera: ekran można ominąć, wołając funkcję
// wprost. Wersja w src/ służy tylko do tego, żeby powiedzieć piszącemu, co jest
// nie tak, zanim kliknie „wyślij".
//
// Obie kopie pilnuje test scripts/testy-warsztat/test_moderacja_sms.mjs —
// rozjazd list słów jest w nim błędem, bo znaczyłby, że serwer przepuszcza
// coś, co ekran blokuje (albo odwrotnie).
