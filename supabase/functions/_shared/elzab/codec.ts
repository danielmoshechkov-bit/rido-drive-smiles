...
import { encodeCp1250 } from './cp1250.ts';
...
/** Tekst CP1250 przycięty/dopełniony spacjami do dokładnie `length` bajtów. */
export function fixedText(text: string, length: number): Uint8Array {
