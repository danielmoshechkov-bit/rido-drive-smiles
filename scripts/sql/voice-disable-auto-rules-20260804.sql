-- Wyłączenie pięciu auto-reguł wygenerowanych przez voice-call-analyze 04.08.2026,
...
-- Odwrócenie: scripts/sql/voice-disable-auto-rules-20260804-rollback.sql
--
--   supabase db query --linked -f scripts/sql/voice-disable-auto-rules-20260804.sql
...
-- Weryfikacja: oczekiwane 10 aktywnych, 16 wyłączonych.
SELECT
